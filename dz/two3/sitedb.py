...
def psychology():
    db = get_db()
    dbase = FDataBase(db)
    return render_template('psychology.html', menu=dbase.get_menu(), posts2=dbase.get_posts_annonce())
...
def show_post(id_post):
    ...
    return render_template('post.html', menu=dbase.get_menu(), title=title, post=post, post2=post)
